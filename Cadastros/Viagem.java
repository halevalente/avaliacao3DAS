...
public class Viagem {
	...
	public int getDuracaoHoras() {
		return new GetDuracaoHoras(this, horaTermino, horaInicio, minutosTermino, minutosInicio).calcular();
	}

	public int getDuracaoMinutos() {
		return new GetDuracaoMinutos(this, minutosTermino, minutosInicio).calcular();
